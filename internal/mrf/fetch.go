...
func GetBearerToken(client ServiceClient) (string, error) {
...
func GetArtistID(artist []string, client ServiceClient) (string, error) {
	...
	bearerToken, err := GetBearerToken(client)
